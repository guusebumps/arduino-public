...
class Mitov_DNSClient
{
    ...
    static constexpr uint16_t  RESPONSE_FLAG               = 1 << 15;
    static constexpr uint16_t  QUERY_RESPONSE_MASK         = 1 << 15;
    static constexpr uint8_t   OPCODE_STANDARD_QUERY       = 0;
    static constexpr uint16_t  OPCODE_INVERSE_QUERY        = 1 << 11;
    static constexpr uint16_t  OPCODE_STATUS_REQUEST       = 2 << 11;
    static constexpr uint16_t  OPCODE_MASK                 = 15 << 11;
    static constexpr uint16_t  AUTHORITATIVE_FLAG          = 1 << 10;
    ...
    static constexpr uint32_t  TYPE_A                      = 0x0001;
    static constexpr uint32_t  CLASS_IN                    = 0x0001;
    ...
    uint16_t htons( uint16_t AValue ) { return AValue; }
